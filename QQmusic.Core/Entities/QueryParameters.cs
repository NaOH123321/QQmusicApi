...
{
    /**
     * @apiDefine QueryParameters
     *
     * @apiParam {int} [pageIndex=0] 请求的当前页.
     * @apiParam {int} [pageSize=100]  每页的个数，最大每页的个数为10000.
     * @apiParam {string} [orderBy]  要排序的字段.
     * @apiParam {string} [fields]  要塑性的字段.
     */
